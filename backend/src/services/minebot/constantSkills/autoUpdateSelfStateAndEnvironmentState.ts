...
class AutoUpdateSelfStateAndEnvironmentState extends ConstantSkill {
    private mcData: any;
    constructor(bot: CustomBot) {
        super(bot);
        this.skillName = 'auto-update-self-state-and-environment-state';
    ...
    async run() {
        ...
        try {
            ...
            this.bot.selfState.botHeldItem = this.bot.heldItem ? this.bot.heldItem.name : 'なし';
...
export default AutoUpdateSelfStateAndEnvironmentState;
