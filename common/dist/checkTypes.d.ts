import { DiscordGuild, DiscordMessageInput, ILog, OpenAIMessageInput, OpenAIMessageOutput, RealTimeAPIEndpoint, WebMonitoringInput, WebMonitoringOutput, WebScheduleInput, WebScheduleOutput } from "./types";
...
export declare const isRealTimeAPIEndpoint: (endpoint: RealTimeAPIEndpoint) => endpoint is RealTimeAPIEndpoint;
...
export declare const isDiscordMessageInput: (message: DiscordMessageInput) => message is DiscordMessageInput;
