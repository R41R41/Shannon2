...
export type PromptType = TwitterSchedulePostEndpoint | "base_text" | "base_voice" | "discord" | "minecraft" | "weather_to_emoji" | "forecast_for_toyama_server" | "youtube" | "planning" | "decision";
export type ConversationType = "text" | "audio" | "realtime_text" | "realtime_audio" | "endpoint" | "log" | "user_transcript";
...
export type TwitterSchedulePostEndpoint = "about_today" | "forecast" | "fortune";
...
export type MemoryZone = "web" | DiscordGuild | "twitter:schedule_post" | "twitter:post" | "minecraft" | "youtube";
export type EventType = "twitter:post_scheduled_message" | "twitter:post_message" | "twitter:get_message" | "youtube:get_stats" | "youtube:get_message" | "youtube:post_message" | "discord:get_message" | "discord:post_message" | "minecraft:get_status" | "minecraft:start_server" | "minecraft:stop_server" | "minecraft:action" | "minecraft:env_input" | "minecraft:get_message" | "minecraft:post_message" | "web:get_message" | "web:post_message" | "web:get_schedule" | "web:post_schedule" | "web:call_schedule" | "web:log";
...
export interface Event {
    type: EventType;
    memoryZone: MemoryZone;
    data: TwitterMessageInput | OpenAIMessageInput | DiscordMessageInput | ILog | TwitterMessageOutput | OpenAIMessageOutput | DiscordMessageOutput | MinecraftInput | MinecraftOutput | SchedulerInput | SchedulerOutput;
